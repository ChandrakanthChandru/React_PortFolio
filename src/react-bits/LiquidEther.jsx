...
class Output {
  constructor(common, mouse, paletteTex) {
    this.common = common;
    this.mouse = mouse;
...
class WebGLManager {
  constructor(common, mouse, paletteTex, props) {
    this.common = common;
    this.mouse = mouse;
    this.paletteTex = paletteTex;
    this.props = props;
    ...
    this._onVisibility = () => {
      ...
      if (hidden) {
        this.pause();
      } else if (this.props.isVisibleRef && this.props.isVisibleRef.current) {
        this.start();
      }
    };
  ...
  init() {
    ...
    this.output = new Output(this.common, this.mouse, this.paletteTex);
  }
  resize() {
    this.common.resize();
    this.output.resize();
...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    const webgl = new WebGLManager(common, mouse, paletteTex, {
      $wrapper: container,
      autoDemo,
      autoSpeed,
      autoIntensity,
